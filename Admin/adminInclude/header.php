...
<body>
 <!-- Top Navbar -->
 <nav class="navbar navbar-dark fixed-top p-0 shadow" style="background-color: rgba(2, 3, 43);">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="adminDashboard.php"> Invictus Educare  <small class="text-white">Admin Area</small></a> 
 </nav>

 <!-- Side Bar -->
 <div class="container-fluid mb-5 clr" style="margin-top:40px;">
  <div class="row">
   <nav class=" col-sm-3 col-md-2 sidebar bg-light py-5 d-print-none">
