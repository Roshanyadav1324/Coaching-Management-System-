...
<head>
 ...
 <!-- Custom CSS -->
 <link rel="stylesheet" href="../css/stustyles.css">

</head>

<body>
 <!-- Top Navbar -->
 <nav class="navbar navbar-dark fixed-top flex-md-nowrap p-0 shadow" style="background-color: rgba(2, 3, 43);">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="../">INVITCUS Educare</a>
 </nav>
