...
?>  
    ...
    <div class="container-fluid vid-marg">
 <div class="vid-parent">
  <video playsinline autoplay muted loop>
   <source src="video/Fly_Through_Formulas_Black.mp4">
  </video>
  <div class="vid-overlay"></div>
 </div>
<div class="vid-content">
<h1 class="my-content">Welcome to Invictus Educare</h1>
<small class="my-content">Let's grow together</small><br><br>
        <?php    
...
<br><br>
    ...
    <!-- Start About Section -->
    <div class="container-fluid p-4" style="background-color:#527ffc">
      <div class="container" style="background-color:#527ffc; color:white;">
        <div class="row text-center">
          ...
          <div class="col-sm">
            <h5>Category</h5>
            <a class="text-dark" href="./courses.php">Class 6-8</a><br />
            <a class="text-dark" href="./courses.php">Class 9-10</a><br />
            <a class="text-dark" href="./courses.php">11 & 12 foundation</a><br />
            
          </div>
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Invictus Educare<br> Caption Complex <br> Near City Hospital <br> Naka No: 5, Darbhanga <br> Ph. 9852322566 </p>
          </div>
        </div>
      </div>
